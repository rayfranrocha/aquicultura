<template>
    <div>
        <fieldset>
            <div class="row">
                <h2 id="textoPassoAtual" class="heading-secondary no-hover u-center-text-2">PASSO 4 DE 4</h2>
                <hr class="small">
                ...
                <div class="passo-3 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select v-model="dadosInscricao.tipoInscricao" class="custom-select" id="tipoInscricao">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select v-model="dadosInscricao.formaPagamento" class="custom-select" id="tipoPagamento">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="(minicurso, index) in listMinicurso" :key="minicurso._id">
                                    <td>
                                        <input type="radio" name="minicursoSelected" v-model="minicursoSelected" :value="index" class="checkboxMinicurso">
                                    </td>
        ...
        <div class="row" id="botoesDiv">
            ...
            <div class="col" id="proximo">
                <button @click.prevent="pagar()" class="bt-flat-azul">Realizar pagamento</button>
            </div>
        </div>
